...
?>
                    ...
                    <div class="widget widget-social">
                        <div class="social-circle">
                            <a href="https://www.facebook.com/profile.php?id=100009101916918" class="#"><i class="fa fa-facebook"></i></a>
                            <a href="#" class="#"><i class="fa fa-google-plus"></i></a>
                            <a href="#" class="#"><i class="fa fa-twitter"></i></a>
                            <a href="https://www.youtube.com/@j3stful" class="#"><i class="fa fa-youtube-play"></i></a>
                        </div>
                    </div>
                </div>
